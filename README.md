...
<p align="center">
  한국어 | <a href="README.en.md">English</a> | <a href="README.ja.md">日本語</a> | <a href="README.zh-CN.md">简体中文</a> | <a href="README.zh-TW.md">繁體中文</a> | <a href="README.vi.md">Tiếng Việt</a>
</p>
...
| 마우스 사용 | 상태바 `TIP` 클릭/hover, 우클릭 메뉴, 팁 창 항목 클릭을 지원합니다. |
...
실제 설정은 `init.lua` 하나를 기준으로 유지하고, 언어별 파일은 선택 언어를 표시한 뒤 `init.lua`를 불러오는 얇은 wrapper입니다.
